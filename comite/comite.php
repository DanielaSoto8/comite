...
$query = "SELECT documento_aprendiz, nombre_aprendiz, correo_aprendiz, id_grupo, programa_formacion,nombre_instructor, correo_instructor FROM informe WHERE estado = 'Notificado'";
                            ...
                            <form action="procesar_comite.php" method="POST">
                                <table id="estudiantesPendientes" class="table table-bordered table-hover">
                                    <thead class="bg-green-500 text-white">
                                        <tr>
                                            <th><input type="checkbox" id="select_all" onclick="toggleCheckboxes()"> Seleccionar Todos</th>
                                            <th>Documento</th>
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="selected_aprendices[]" value="<?php echo $row['documento_aprendiz']; ?>">
                                            </td>
                                ...
                                <input type="hidden" name="id_grupo" value="id_grupo"> <!-- Asegúrate de reemplazar con el ID del grupo adecuado -->
                                <button type="submit" class="btn bg-green-600 hover:bg-green-700 text-white">Procesar Selección</button>
                            </form>
                        </div>
                    </div>
