...
<div class="container mt-5">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="needs-validation" novalidate>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="criterios_evaluacion" name="criterios_evaluacion" rows="3" required></textarea>
            <div class="invalid-feedback">
                Campo obligatorio.
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="objetivos_reunion" name="objetivos_reunion" rows="3" required></textarea>
            <div class="invalid-feedback">
                Campo obligatorio.
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nombre_aprendiz" name="nombre_aprendiz" required>
            <div class="invalid-feedback">
                Campo obligatorio.
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="resultados_no_aprobados" name="resultados_no_aprobados" rows="3" required></textarea>
            <div class="invalid-feedback">
                Campo obligatorio.
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="actividades_aprendizaje" name="actividades_aprendizaje" rows="4" required></textarea>
            <div class="invalid-feedback">
                Campo obligatorio.
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="evidencias_aprendizaje" name="evidencias_aprendizaje" rows="4" required></textarea>
            <div class="invalid-feedback">
                Campo obligatorio.
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="compromisos_actividad" name="compromisos_actividad" required>
            <div class="invalid-feedback">
                Campo obligatorio.
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="compromisos_responsable" name="compromisos_responsable" required>
            <div class="invalid-feedback">
                Campo obligatorio.
            </div>
        </div>
        ...
        <h4>Asistentes</h4>
        <div class="form-group">
            <label for="asistentes">Asistentes (Nombres y Apellidos, Cédula, Tipo de Vinculación, Empresa/Dependencia, Correo Electrónico, Celular/Extensión, Firma)</label>
